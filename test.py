...
testOrder("ཁ གད་ གན་ གར་ གལ་ གས་ ང ད དག་ དང་ དབ་ དམ་ དར་ དལ་ དས་ ན ཕ བག བད་ བར་ བལ་ བས་ མ མག་ མད་ མབ་ མར་ མལ་ མས་ ཙ", "2 letters ambiguous")
testOrder("ཁ དགི བགི མགི ང དངི ཅ ད གདི བདི མདི ན གནི ཕ དབི མ དམི ས གསི བསི ཧ", "2 letters ambiguous with i")
