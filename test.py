...
testOrder("ཀག ཀགས ཀཊ ཀང ཀྃ ཀངས ཀད ཀམ ཀཾ ཀམས ཀའ", "standard, second and contracted suffixes")
testOrder("ཀིག ཀིགས ཀིཊ ཀིང ཀིྃ ཀིངས ཀིད ཀིམ ཀིཾ ཀིམས ཀིའ", "contracted suffixes with i")
testOrder("ཀུག ཀུགས ཀུཊ ཀུང ཀུྃ ཀུངས ཀུད ཀུམ ཀུཾ ཀུམས ཀུའ", "contracted suffixes with u")
